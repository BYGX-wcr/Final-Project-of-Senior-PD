...
#include "../FinalProject-of-SPD/recorddialog.h"
...
QT_MOC_LITERAL(1, 13, 12), // "returnRecord"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 10) // "QSqlRecord"

    },
    "RecordDialog\0returnRecord\0\0QSqlRecord"
};
...
void RecordDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->returnRecord((*reinterpret_cast< QSqlRecord(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (RecordDialog::*_t)(QSqlRecord );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RecordDialog::returnRecord)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RecordDialog::returnRecord(QSqlRecord _t1)
{
